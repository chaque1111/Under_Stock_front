    ...
    <div className={styles.containerMaster}>
      ...
      <div className={styles.containUbication}>
        ...
        >
          <p className={styles.mapLink}>
            Puedes encontrarnos en Hipólito Yrigoyen 1994, Ciudad de Corrientes{" "}
          </p>
        </a>
        <a
          className={styles.link}
      ...
      <div className={styles.containUnderDescription}>
        ...
        <p className={styles.descriptionUnder}>
          Somos una tienda de Argentina Situada en la Ciudad de Corrientes. Que
          vino a revolucionar la industria de la moda mediante nuestra gran
          variedad de productos , En Under Stock vas a encontrar productos
          únicos y 100% originales.
        </p>
      </div>
      <Footer></Footer>
    </div>
